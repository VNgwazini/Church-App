...
import {Directions,YouTube, CreditCard, MenuBook} from "@material-ui/icons"
...
export default function Footer() {
  return (
    ...
    <div className="footer d-flex align-items-center justify-content-between pl-1 pr-2 py-4">
      <span className="d-flex justify-content-start">All Nations African SDA Church © 2022 </span>
